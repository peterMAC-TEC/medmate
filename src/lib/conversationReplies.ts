...
export interface ReplySet {
  ...
  prescriptionAskConfirm: (name: string, dosage?: string, doctorName?: string) => string;
  prescriptionRecorded: (name: string, dosage?: string) => string;
...
const en: ReplySet = {
  ...
  prescriptionAskConfirm: (name, dosage, doctorName) =>
    `Just to make sure — should I add ${name}${dosage ? ` ${dosage}` : ""} to your medicines${doctorName ? `, prescribed by ${doctorName}` : ""}?`,
  prescriptionRecorded: (name, dosage) => `Got it. I've added ${name}${dosage ? ` ${dosage}` : ""} to your medicines.`,
...
const hi: ReplySet = {
  ...
  prescriptionAskConfirm: (name, dosage, doctorName) =>
    `बस पक्का करने के लिए — क्या मैं ${name}${dosage ? ` ${dosage}` : ""} को आपकी दवाइयों में जोड़ दूँ${doctorName ? `, जो ${doctorName} ने लिखी है` : ""}?`,
  prescriptionRecorded: (name, dosage) => `ठीक है। मैंने ${name}${dosage ? ` ${dosage}` : ""} को आपकी दवाइयों में जोड़ दिया है।`,
...
const ta: ReplySet = {
  ...
  prescriptionAskConfirm: (name, dosage, doctorName) =>
    `உறுதிப்படுத்திக் கொள்ள — ${name}${dosage ? ` ${dosage}` : ""} ஐ உங்கள் மருந்துகளில் சேர்க்கவா${doctorName ? `, ${doctorName} பரிந்துரைத்தது` : ""}?`,
  prescriptionRecorded: (name, dosage) => `சரி. ${name}${dosage ? ` ${dosage}` : ""} ஐ உங்கள் மருந்துகளில் சேர்த்துவிட்டேன்.`,
...
const te: ReplySet = {
  ...
  prescriptionAskConfirm: (name, dosage, doctorName) =>
    `నిర్ధారించుకోవడానికి — ${name}${dosage ? ` ${dosage}` : ""} మీ మందుల జాబితాలో చేర్చమంటారా${doctorName ? `, ${doctorName} సూచించారు` : ""}?`,
  prescriptionRecorded: (name, dosage) => `సరే. ${name}${dosage ? ` ${dosage}` : ""} ను మీ మందుల జాబితాలో చేర్చాను.`,
...
const kn: ReplySet = {
  ...
  prescriptionAskConfirm: (name, dosage, doctorName) =>
    `ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಲು — ${name}${dosage ? ` ${dosage}` : ""} ಅನ್ನು ನಿಮ್ಮ ಔಷಧಿಗಳ ಪಟ್ಟಿಗೆ ಸೇರಿಸಲೇ${doctorName ? `, ${doctorName} ಸೂಚಿಸಿದ್ದಾರೆ` : ""}?`,
  prescriptionRecorded: (name, dosage) => `ಸರಿ. ${name}${dosage ? ` ${dosage}` : ""} ಅನ್ನು ನಿಮ್ಮ ಔಷಧಿಗಳ ಪಟ್ಟಿಗೆ ಸೇರಿಸಿದ್ದೇನೆ.`,
...
const ml: ReplySet = {
  ...
  prescriptionAskConfirm: (name, dosage, doctorName) =>
    `ഉറപ്പുവരുത്താൻ — ${name}${dosage ? ` ${dosage}` : ""} നിങ്ങളുടെ മരുന്നുകളിൽ ചേർക്കട്ടെയോ${doctorName ? `, ${doctorName} നിർദ്ദേശിച്ചത്` : ""}?`,
  prescriptionRecorded: (name, dosage) => `ശരി. ${name}${dosage ? ` ${dosage}` : ""} നിങ്ങളുടെ മരുന്നുകളിൽ ചേർത്തു.`,
